...
def main(input_dir, output_dir, metrics_choice, metrics_gen, device='cpu', model_path=None):
    ...
    for model in all_model:
        ...
        all_file = [all_file[i] for i in range(len(all_file)) if all_file[i].endswith(".json")]
...
if __name__ == '__main__':
    ...
    parser.add_argument("--metrics_choice", type=str, default="Accuracy", help="metrics for multiple choice questions, can be 'Accuracy'")
