...
class gemma2_generator(model_generator):
    def __init__(self, f_path, is_few_shot, device, is_vllm, model_path, model_name, tensor_parallel_size, gpu_memory_utilization):
        ...
        '''
        super(gemma2_generator, self).__init__(f_path, is_few_shot, device, is_vllm, model_path, tensor_parallel_size, gpu_memory_utilization)
